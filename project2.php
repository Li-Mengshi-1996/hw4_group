...
<head>
<meta charset="utf-8">
<title>Project 2: CS 5700 Fundamentals of Computer Networking: David Choffnes, Ph.D.</title>
...
<h2>Project 2: Web Crawler</h2>
<p>
<b>This project is due at 11:59pm on February 15, 2022. This project is for 5700 students only.</b>
</p><p>
<h2>Description</h2>
...
<a href="https://project2.5700.network">Fakebook</a>.
</p><p>
...
<h2>Fakebook</h2>
We have set up a fake social network for this project called <a href="https://project2.5700.network">Fakebook</a>.
Fakebook is a very
...
that the root page for Fakebook is available at <a href="https://project2.5700.network">
project2.5700.network</a>. You may also assume that the log-in form for Fakebook is available
at <a href="https://project2.5700.network/accounts/login/?next=/fakebook/">
project2.5700.networkaccounts/login/?next=/fakebook/</a>.
</p><p>
...
URLs that point to pages on https://project2.5700.network</b>. For example, it would be valid to crawl
<i>https://project2.5700.network/fakebook/018912/</i>, but it would not be valid to crawl
<i>https://www.facebook.com/018912/</i>.
</ul>
</p><p>
</p><p>
...
In addition to crawling Fakebook, your web crawler must be able to correctly handle <a href="https://en.wikipedia.org/wiki/List_of_HTTP_status_codes">HTTP status codes</a>. Obviously, you need to handle 200, since that means
...
I highly recommend the <a href="https://www.jmarshall.com/easy/http/">HTTP Made Really Easy</a>
tutorial as a starting place for students to learn about the HTTP protocol. Furthermore, the
developer tools built-in to the Chrome browser, as well as the <a href="https://getfirebug.com/">Firebug</a>
...
on <b>unmodified</b> Khoury Linux machines <b>on the command line</b>. Do not use libraries that are not
installed by default on the Khoury Linux machines. Similarly, your code must compile and run on the
...
Before turning in your project, you must register yourself by executing the following script:
<pre>$ /course/cs5700sp22/bin/register project2 [your-ccis-username]</pre>
...
<li>A file called <i>secret_flags</i>. This file should contain your <i>secret flags</i>, one per line, in plain ASCII.</li>
</ul>
...
<pre>$ /course/cs5700sp22/bin/turnin project2 [project directory]</pre>
...
file. You may submit as many times as you
...
<h2>Grading</h2>
<p>This project is worth 12 points. You will receive full credit if 1) your code compiles, runs, and produces the
expected output, 2) you have not used any illegal libraries, and 3) you successfully submit your 
...
<p>
<b>In addition, you must include all required files, with filenames and content exactly as specified on the project page; 
your code must be documented using useful comments; and your code must produce correct output for any valid username/password, <i> not just yours</i>.</b>
</p>
 ...
 <script>
    ...
    Last updated
    <!-- #BeginDate format:Am1 -->February 02, 2022<!-- #EndDate -->.
    </p>
    </div>
    </html>
